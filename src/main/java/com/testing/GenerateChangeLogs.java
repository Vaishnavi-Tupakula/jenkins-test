...
public class GenerateChangeLogs {
    ...
    private static final String ROOT_FOLDER = System.getenv("WORKSPACE") != null ? System.getenv("WORKSPACE") + "/src/main/resources/Release 1.0.0" 
                                                                                 : "src/main/resources/Release 1.0.0";
